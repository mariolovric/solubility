...
def split_rand_pick(df, splitting_column1, splitting_column2):
    """
    ...
    return train_pick, val_pick, test_pick, train_rand, test_rand
...
def return_sets(sets, x, y, train_pick, val_pick, test_pick, train_rand, test_rand):
    """
